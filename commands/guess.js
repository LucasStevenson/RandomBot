...
module.exports.run = async (bot, message, args) => {
    ...
    message.channel.awaitMessages(filter, {max: 1}).then(collected => {
        ...
        if(collected.first().content.toLowerCase() === "end"){ //if user types in end, the game ends
            return message.channel.send("You decided not to play");
        }

        var userA = collected.first().content; //defining their first guess as userA
        if(collected.first().content.toLowerCase() === "hint") return message.channel.send("Well you needa guess a fucking number before I can give a hint");
        ...
        if(userA == result){ //if their first guess was the answer, they got it right and game ends
            ...
            message.reply("Oof you got it wrong...2 more guess and 1 more hint")
            ...
            message.channel.awaitMessages(filter, {max: 1}).then(collected => { //setting the first thing they type in as an their input
                ...
                if(collected.first().content.toLowerCase() === "hint") {
                    if(userA > result){ //if the previous, userA, input was greater than the answer, then this code runs
                        message.reply("Your previous input of " + userA + " was too high") //tells user than their userA input was too large
                        message.reply("Now you have 2 more guesses and 0 more hints") //tells them they no longer have a hint
                        ...
                        message.channel.awaitMessages(filter, {max: 1}).then(collected => {
                            ...
                            if(userB == result){ //if their second input, userB, is correct, bot tells them so
                                ...
                                message.reply("Oof you got it wrong...1 more guess and 0 more hints")
                            }
                        ...
                        message.channel.awaitMessages(filter, {max: 1}).then(collected => {
                            ...
                            if(userC == result){ //if their 3rd hint is correct. the bot will tell them so, vice versa
                                ...
                                message.reply("Rip you guessed all 3 wrong. I was thinking of the number " + result) //if userC, aka the last guess is incorrect, bot says so and game ends
                            }
                        ...
                        message.reply("Your previous input of " + userA + " was too low") //bot sends this message if their previous guess was below the result
                        message.reply("Now you have 2 more guesses and 0 more hints") //tells them that they used their hint and cant use it anymore
                        ...
                        message.channel.awaitMessages(filter, {max: 1}).then(collected => {
                            ...
                            if(userB == result){ //if their 2nd guess, userB, is correct, bot says so, if not, bot also says so
                                ...
                                message.reply("Oof you got it wrong...1 more guess and 0 more hints") //now that they got 2 guesses wrong bot tells them they only have one more guess
                            }
                        ...
                        message.channel.awaitMessages(filter, {max: 1}).then(collected => {
                            ...
                            if(userC == result){ //last guuess with 0 hints
                                ...
                                message.reply("Rip you guessed all 3 wrong. I was thinking of the number " + result) //bot tells them they got it wrong
                            }
                        })
                    ...
                    if(userB == result){ //if ur 2nd guess is equal to answer, bot will say so
                        ...
                        message.reply("Oof you got it wrong...1 more guess and 1 more hint")
                        ...
                        message.channel.awaitMessages(filter, {max: 1}).then(collected => {
                            ...
                            if(collected.first().content.toLowerCase() === "hint") { //if user uses hint command when they only have 1 chance left
                                if(userB > result){ //if their 3rd guess, userB, was larger than the answer
                                    message.reply("Your previous input of " + userB + " was too high")
                                    message.reply("Now you have 1 more guess and 0 more hints") //no longer have a hint and just 1 guess
                                    ...
                                    message.channel.awaitMessages(filter, {max: 1}).then(collected => {
                                        ...
                                        if(userE == result){ //if their last guess, userE, is the right number, bot will specify so
                                            ...
                                            message.reply("Rip you guessed all 3 wrong. I was thinking of the number " + result)
                                        }
                                    ...
                                    message.reply("You previous input of " + userB + " was too low") //tells them their second , userB, guess was too low
                                    message.reply("Now you have 1 more guess and 0 more hints")
                                ...
                                if(userE == result){
                                    ...
                                    message.reply("Rip you ran outta attempts. The number was " + result + ". Next time you should use ur hints...they actually help")
                                }
                            }
                        })
                    }
